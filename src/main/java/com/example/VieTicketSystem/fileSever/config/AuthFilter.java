...
public class AuthFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        if ((requestURI.equals("/auth/login") || requestURI.equals("/auth/login/oauth2/google") || requestURI.isEmpty()
                ...
                || requestURI.equals("/auth/log-out") || requestURI.equals("/")|| requestURI.equals("/search-event") || requestURI.equals("/searchResults")|| requestURI.equals("/viewAllEvent") || requestURI.equals("/rating")
