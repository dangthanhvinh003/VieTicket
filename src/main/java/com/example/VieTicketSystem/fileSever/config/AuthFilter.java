...
public class AuthFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if ((requestURI.equals("/auth/login") || requestURI.equals("/auth/login/oauth2/google") || requestURI.isEmpty() || requestURI.equals("/auth/reset-password") || requestURI.equals("/auth/password-reset") || requestURI.equals("/auth/verify-otp") || requestURI.equals("/signup") || requestURI.equals("/auth/log-out") || requestURI.equals("/") || requestURI.equals("/search-event") || requestURI.equals("/searchResults") || requestURI.equals("/rating") || requestURI.startsWith("/viewdetailEvent") || requestURI.startsWith("/api")) && !isUnverified) {
            chain.doFilter(request, response);
            return;
        }
        ...
        if (isAdmin(user)) {
            ...
            chain.doFilter(request, response);
        } else if (isUser(user) && (requestURI.startsWith("/change") || requestURI.startsWith("/editUser") || requestURI.startsWith("/upload") || requestURI.startsWith("/tickets")) || requestURI.startsWith("/auth/verify-email") || requestURI.startsWith("/purchase")) {
            ...
            if (organizer != null) {
                ...
                if (organizer.isActive() && requestURI.startsWith("/createEvent") || requestURI.startsWith("/inactive-account") || (requestURI.startsWith("/change") || requestURI.startsWith("/editUser") || requestURI.startsWith("/upload") || requestURI.startsWith("/upload/poster") || requestURI.startsWith("/upload/banner") || requestURI.startsWith("/add-event") || requestURI.startsWith("createEvent") || (requestURI.startsWith("/seatMap") && eventCreated) || (requestURI.startsWith("/seatMap/NoSeatMap") && eventCreated) || (requestURI.startsWith("/seatMap/SeatMapBeta") && eventCreated) || requestURI.startsWith("/viewMyListEvent") || requestURI.startsWith("/allEvents") || requestURI.startsWith("/pendingEvents") || requestURI.startsWith("/approvedEvents") || requestURI.startsWith("/passedEvents") || requestURI.startsWith("/seatMapEdit") || requestURI.startsWith("/seatMapDelete") || requestURI.startsWith("/noModelEditPage") || (requestURI.startsWith("/seatMap/NoSeatMapEdit")) || (requestURI.startsWith("/seatMap/SeatMapBetaEdit")) || requestURI.startsWith("/editSuccess")) || requestURI.startsWith("/eventEditPage") || requestURI.startsWith("/eventEditSubmit") || requestURI.startsWith("/viewStatistics")) {
